...
public class QuizManager : MonoBehaviour
{
    ...
    public void Wrong()
    {
        ...
        if (ScoreP <= 0)
        {
            ...
            return; // Salir del m�todo para no generar m�s preguntas
        }
    ...
    void SetAnswers()
    {
        ...
        {
            if (i < QnA[currentQuestion].Answers.Length) // Verifica que el �ndice est� dentro del rango
            {
            ...
            {
                // Oculta el bot�n si no hay suficientes respuestas para esta pregunta
    ...
    void generateQuestion() 
    {
        ...
        {
            // Mostrar un mensaje de finalizaci�n del quiz en consola.
